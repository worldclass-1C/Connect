...
Функция ПодготовитьТелоHTTPЗапроса(Знач Токен, Знач ДанныеЗапроса, Знач Пользователь, Знач ЯзыкПриложения, Знач ЧасовойПояс, Знач ВидПриложения) Экспорт
...
Функция СформироватьСтруктуруОтвета(ТелоОтвета = "", ТелоЗапроса = "", ОписаниеОшибки = "", Токен = "") Экспорт
...
Функция ВыполнитьЗапросВФоне(Выборка, Заголовки, ТелоЗапроса, Адрес) Экспорт 
...
Функция ДобавитьСтрокуВТаблицуАтрибутов(ТаблицаАтрибутов, Ключ, Значение, Тип)
...
Процедура ВыполнитьЗапросВУчетнойСистеме(Выборка, Заголовки, ТелоЗапроса, Адрес) Экспорт
