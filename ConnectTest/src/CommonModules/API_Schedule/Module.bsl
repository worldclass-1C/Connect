Procedure gymSchedule(parameters) Export
	...
	If requestStruct.Property("employeeId")
			And ValueIsFilled(requestStruct.employeeId) Then
	...
	EndIf;
	If requestStruct.Property("serviceDescriptionId")
			And ValueIsFilled(requestStruct.serviceDescriptionId) Then
